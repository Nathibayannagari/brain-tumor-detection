...
#os.environ['TCL_LIBRARY']="C:/Users/bandi/anaconda3/Library/lib/tcl8.6"
#os.environ['TCL_LIBRARY']="C:/Users/bandi/anaconda3/Library/lib/tcl8.6"
...
class Gui:
    ...
    def __init__(self):
        ...
        WindowLabel = tkinter.Label(self.FirstFrame.getFrames(), text="BRAIN TUMOR DETECTION", height=2, width=35)
        WindowLabel.place(x=320, y=30)
        WindowLabel.configure(background="White", font=("Comic Sans MS", 20, "bold"))
